...
export default function Home() {
  ...
  const { data: categories, isLoading: isCategoriesLoading }: any = useGetCategoriesQuery({});
  const { data: subCategories, isLoading: isSubCategoriesLoading }: any = useGetSubCategoriesQuery({});
  const { data: baseCategories, isLoading: isBaseCategoriesLoading }: any = useGetBaseCategoriesQuery({});
  const { data: response, isLoading }: any = useGetProductsQuery({});
